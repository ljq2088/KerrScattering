...
self-channel nonlinear Green-function calculation.  Section~\ref{sec:spinminus2}
...
amplification.  The cubic angular projector, the Kerr-covariant self-channel
radial source, and the first-order nonlinear Green-function amplitudes are now
implemented.  The nonlinear table is controlled by quadrature, spectral-order,
and matching-window scans.  The next physics step is to extend this calculation
from the representative self-channel cases to a broader coupled
$\ell'$-channel nonlinear scattering survey.
...
scan is stored in
\texttt{kerr\_scalar\_nonlinear\_control\_scan.csv}.
