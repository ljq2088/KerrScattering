...
For deep learning of the literature, use the staged map in `docs/literature/gravity_literature_map.md`, the English curriculum in `docs/literature/deep_learning_curriculum.md`, the convention ledger in `docs/literature/convention_ledger.md`, and the paper cards in `docs/literature/paper_cards.md`. Refresh `results/literature/arxiv_catalog.json` with `python scripts/build_literature_manifest.py`. For every paper, make a compact evidence record with:
